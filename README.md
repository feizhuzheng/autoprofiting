...
**Playbook v64** — Last updated March 30, 2026 21:56 ET
...
- Track macro stress thresholds: VIX 30, 30Y yield 5%, Brent $115, Michigan Sentiment <55, Conference Board Expectations <80, rate hike probability >50%. When 2+ cluster, go fully defensive. As of March 30 late PM: 4/6 triggered (VIX 31.07, Brent $115.35, Michigan 53.3, CB Expectations 65.2). Morning normalization to 2/6 reversed within 75 minutes — intraday indicator moves are noise, only settlement values count. → *Before any BUY, check all indicators at official close values. If 2+ triggered, no new positions. Distinguish real-time indicators (VIX, yields, oil, rate futures) from lagging surveys (Michigan, CB). Only count indicators as cleared at settlement — intraday dips below thresholds do not count.*
...
- A selective blockade that gets legislated becomes structural. Iran's Hormuz toll system (yuan-denominated, $2M/transit, parliament legislating) is harder to reverse than a military blockade. Once codified, even a ceasefire may not reopen normal traffic. → *When a blockade shifts from military ad hoc to legal/institutional, treat the supply disruption as permanent for modeling purposes. Oil ceiling stays elevated longer than the conflict itself.*
